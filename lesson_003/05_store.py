...
# Временная это без использования, когда мы пишем вот так for _ range(10):
# А тут у нас три вхождения, и код уже стол читаемый, по названию понятно что там внутри
