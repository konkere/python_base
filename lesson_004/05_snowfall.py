...
# TODO Попробуем сделать так! Упростить
# TODO До цикла while заведем переменную length_snow = 50
...
# TODO создаем точку и печатаем снежинку тоже отдельными строками.
...
# TODO Условие пишем в конце цикла!
# TODO Напишем так: Если Y < length_snow то в списке параметры_снежинок мы по индексу присвоим 600, это потолок!
# TODO length_snow +=1
# TODO Можно добавить условие чтобы сугроб был не высокий!
