...
def log_errors(log_file):
    ...
    # TODO перепутал флаги, можете написать для чего нам эта строка нужна ?
    # TODO чистить файл перед записью данных ?
    #
    # TODO по сути -- да. Создаёт пустой файл, если такого не было. Если был, создаёт пустой вместо существующего.
