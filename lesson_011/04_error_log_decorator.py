...
# TODO правильней будет тут сделать метод на проверку средствами os
# TODO если файл есть то удалить его.


def log_errors(log_file):

    # или записать в две строки тут, лучше  и быстрее чем его перезаписывать создавая его.
    # зачем нам эти сложности открытием закрытием.
