...
# TODO суть задания работа с объектами и списками, у нас должны быть реализованы три функции, которыми мы оперируем
# TODO экземплярами класса, и вот в третьей(или второй) функции которая отвечает за количество упавших можно и удалять
# TODO снежинки которые нам уже не нужны, т.е. снежинка долетела до низа мы ее посчитали и удалили, а следующим методом
# TODO добавили еще снежинок сколько упало в конец списка.

# TODO в итоге у вас должно получиться один метод подсчитывает и удаляет, второй метод добавляет сколько упала в конец
# TODO списка, и также не меняется длинна изначального списка. И главный метода создает.
