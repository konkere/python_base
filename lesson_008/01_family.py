...
class Wife(Man):
    ...
    def buy_fur_coat(self):
        ...
        if self.house.money >= 350 + self.house.citizens * 30:
            ...
            # TODO у меня выживаемость 70/30 получается только, если здесь не отнимать "счастье" в этом месте
            # TODO иначе при (-10) - 30/70, при (-5) - 50/50
            # TODO я именно потому больше свободного времени у мужа изначально определил в работу
            # TODO (ну и раз он один работает, должен же он о семье думать)
            # TODO ---------------------------------
            # TODO Я б вернулся к изначальному варианту:
            # TODO Муж единственный работает? Надо на это повысить приоритет.
            # TODO Жена единственная покупает продукты? Тоже повысить приоритет.
            # TODO А кушать они и так прекрасно успевают.
            self.happiness -= 10
